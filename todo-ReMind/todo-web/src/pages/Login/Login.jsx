                        ...
                        <svg data-dc-tpl="24" width="80" height="80" viewBox="0 0 80 80">
                            <defs data-dc-tpl="25">
                                <linearGradient data-dc-tpl="26" id="logoG" x1="0" y1="0" x2="1" y2="1">
                                    <stop data-dc-tpl="27" offset="0%" stopColor="#60A5FA"></stop>
                                    <stop data-dc-tpl="28" offset="100%" stopColor="#818CF8"></stop>
                                </linearGradient>
                            </defs>
                            <rect data-dc-tpl="29" width="80" height="80" rx="20" fill="url(#logoG)"></rect>
                            <path data-dc-tpl="30" d="M22 42l14 14L58 26" stroke="white" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" fill="none"></path>
                        </svg>
                    </div>
                    <h1>ReMind</h1>
